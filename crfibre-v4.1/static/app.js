// CR Fibre v4.1 — JS minimal (aucune dépendance externe)
...
// --- Affiche le champ "précision clôture/travaux" seulement quand utile -----
(function () {
  ...
  function toggle() {
    var v = statut.value;
    wrap.style.display = (v === "Passage en TRAVAUX" || v === "Infructueuse") ? "block" : "none";
  }
